...
static void _gr716_setSysClkDiv(u8 div)
{
	*(gr716_common.pll_base + sys_ref) = (*(gr716_common.pll_base + sys_ref) & ~0xff) | div;
}
...
static void _gr716_sram_init(void)
{
	...
	*(vu32 *)(gr716_common.mctrl0_base + mctrl_cfg2) |= (0xf << 9) | (1 << 7);
}
